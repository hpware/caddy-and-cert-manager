...
export const POST = async (req: NextRequest) => {
  ...
  try {
    ...
    if (sslType === "homecert") {
      ...
      customCertPath = fullchainPath.replace("./certs/created/", "/certs/");
      customKeyPath = privateKey.replace("./certs/created/", "/certs/");
      ...
      // Paths as seen by Caddy container (./certs/created:/certs)
      customCertPath = `/certs/custom-${serviceId}/cert.pem`;
      customKeyPath = `/certs/custom-${serviceId}/key.pem`;
    }
